...
class _MetronomeAppState extends State<MetronomeApp>
  ...
  Future<void> _initializeApp() async {
    await Future.delayed(Duration(seconds: 3)); // Simulating async work
    setState(() {
      _isInitialized = true;
    });
  }
  ...
  void startMetronome(int subdivisions) {
    ...
    _timer = Timer.periodic(
      ...
      if (subdivisions == 1 || tickCount % subdivisions == 0) {
        ...
        // double result = _soloud.getRelativePlaySpeed(handle);
        // _soloud.setRelativePlaySpeed(handle, result * 1.5);
      } else {
  ...
  Widget build(BuildContext context) {
    return _isInitialized
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            if (_currentSectionBpm != null &&
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                      height: 10), // Add space between columns
                                  Column(
                                    crossAxisAlignment:
                                        CrossAxisAlignment.start,
                                    children: [
                    ...
                    if (selectedPiece != null &&
                        selectedPiece!.sections.isNotEmpty)
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 20.0),
                        child: Container(
                          height: 50,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () =>
                                      _showTickSelectionDialog(false),
                                  child: Text(
        ...
        : Scaffold(
            body: Center(
              child: Image.asset(
                'assets/images/Atlantic_Brass_Band.png', // Path to the image asset
                fit: BoxFit
                    .contain, // Optional: Adjust the image scaling as needed
              ),
            ),
          );
  }
